...
$empID=$_SESSION['start'];
  ...
  $acctID='SELECT ACCOUNT_ID, CHG_ACCT_BALANCE, CUSTOMER_LNAME, CUSTOMER_FNAME FROM CHARGE_ACCOUNT, CUSTOMER WHERE CHARGE_ACCOUNT.CUSTOMER_ID=CUSTOMER.CUSTOMER_ID ORDER BY ACCOUNT_ID';
