...
<div class="page-header" style="text-align: center">
    <h1 style="padding-right:15px"><strong><span class= "label label-warning">North Willow Convenience Stores</span></strong></h1>
      <br>
    <h1><span class="label label-primary">Page Access Restriction</h1>
</div>
...
<div class="panel panel-default">
  <?php echo "<div class=\"panel-heading\" role=\"tab\" id=\"heading".$test."\">";?>
    <h4 class="panel-title" style="font-weight:bold; font-size: 150%"><span class="glyphicon glyphicon-exclamation-sign"></span>
        <?php echo 'Notice! You do not have access rights for the requested page. ';?>
    </h4>
</div>
    ...
    <div class="row">
      ...
      <!--<p>The .table-striped class adds zebra-stripes to a table:</p>-->
        <div class="table-responsive">
          ...
          <div class="alert alert-warning" "glyphicon glyphicon-remove-circle">
        <h2> Please head back to the Main Menu.</h2><br><br>
